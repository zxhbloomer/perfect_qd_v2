...
<script>
import { getListApi, updateApi, insertApi, exportAllApi, exportSelectionApi, deleteApi } from '@/api/20_master/dept/dept'
...
export default {
  name: this.PROGRAMS.P_DEPT, // 页面id，和router中的name需要一致，作为缓存
