<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="!meDialogStatus" show-overflow-tooltip sortable="custom" min-width="180" :sort-orders="settings.sortOrders" prop="dept_full_simple_name" label="部门信息" />
